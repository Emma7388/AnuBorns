-- Categories: fixed list seeded at initialization
...
-- Only service role can insert/update/delete (no public write policies)
...
-- Products table (future-ready) referencing categories
